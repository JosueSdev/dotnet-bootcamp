...
";
    ...
    private static async Task EnumerateWithCancellation(Octokit.GitHubClient client)
    {
        int num = 0;
    ...
    private static async IAsyncEnumerable<JToken> RunPagedQueryAsync(Octokit.GitHubClient client,
